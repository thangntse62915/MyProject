        ...
        <div id="main_box">
            ...
            <div class="container">
                <div class="form-signin col-sm-4">
                    ...
                    <input id="txtId" runat="server" class="form-control" placeholder="Id..." />
                    <asp:RequiredFieldValidator ID="RequiredIdValidator" ControlToValidate="txtId" runat="server" ErrorMessage="Id is required" ForeColor="Red"></asp:RequiredFieldValidator>
                    ...
                    <input id="txtFullname" runat="server" class="form-control" placeholder="Fullname..." />
                    <asp:RequiredFieldValidator ID="RequiredFullnameValidator" ControlToValidate="txtFullname" runat="server" ErrorMessage="Fullname is required" ForeColor="Red"></asp:RequiredFieldValidator>
                    <input id="txtAddress" runat="server" class="form-control" placeholder="Address..." />
                    <asp:RequiredFieldValidator ID="RequiredAddressValidator" ControlToValidate="txtAddress" runat="server" ErrorMessage="Address is required" ForeColor="Red"></asp:RequiredFieldValidator>
                    <input id="txtEmail" runat="server" class="form-control" type="email" placeholder="Email..." />
                    <asp:RequiredFieldValidator ID="RequiredEmailValidator" ControlToValidate="txtEmail" runat="server" ErrorMessage="Email is required" ForeColor="Red"></asp:RequiredFieldValidator>
                    <asp:TextBox ClientIDMode="Static" ID="txtBirthday" runat="server" CssClass="form-control" type="date"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredtxtBirthdayValidator" ControlToValidate="txtBirthday" runat="server" ErrorMessage="Birthday is required" ForeColor="Red"></asp:RequiredFieldValidator>
                    ...
                    <asp:Button ID="btnRegister" runat="server" OnClick="btnRegister_Click" Text="Register" CssClass="btn btn-lg btn-primary btn-block" />
                </div>
                <br />
            </div>
            <footer>
