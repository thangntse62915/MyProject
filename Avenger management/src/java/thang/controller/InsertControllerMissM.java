 ...
 * @author THANG NGUYEN
 */
public class InsertControllerMissM extends HttpServlet {

    public static final String INSERT = "admin/ManagerMissionInsert.jsp";
    public static final String ADDTEAM = "admin/ManagerTeamMissionInsert.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (check == true) {
                ...
                String idAdmin = ((MemberDTO) session.getAttribute("INFO")).getUsername();
                dto = new MissionDTO(txtId, txtName, txtLocal, txtLevel, begin, end, "\\image\\mission\\" + txtId + ".rar", "Create", idAdmin);
                System.out.println(dto.toString());
                System.out.println(begin);
                System.out.println(getServletContext().getRealPath("\\") + "image\\" + filename);
                ...
                if (valid == false) {
                    ...
                    if (!action.equals("Create")) {
                        ...
                        session.removeAttribute("HTEAM");
                    }
                }
            }
        } catch (Exception e) {
            if (e.getMessage().contains("duplicate")) {
                err.setErrid("Id is existed");
                request.setAttribute("DTO", dto);
                request.setAttribute("ERR", err);
            }log(e.getMessage());
        } finally {
